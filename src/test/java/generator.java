...
//            strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
            strategy.setInclude(new String[]{"sys_user","sys_company","sys_company_department","sys_company_permission",
                    "sys_dep_permission", "sys_department","sys_employee","sys_permission","sys_user_company"});
